...
- 用户 syscall 目前只有 root regular-file `O_RDONLY`/`O_RDWR openat`、最多 256-byte/单页 mapping 的 read/write、`SEEK_SET lseek`、close，以及特判 stdout write；没有 grow/truncate/stat、directory fd、dup、poll、mmap、owner/mode 权限或任意并发请求；
