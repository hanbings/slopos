...
- `initrd.slp` 仍不是文件系统；独立 ext4 disk 目前能走 group 0、depth-0 extent、线性单块目录路径并读取单块 regular file，但尚无多 group/deep extent/htree/symlink/VFS/write/journal；btrfs 未实现。
