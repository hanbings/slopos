...
required_markers=(
    ...
    "SLOPOS-PROCESS: pid=1 parent=0 source=vfs path=/sbin/slop-init argv1=--system format=elf64 entry=0x40000000 segments=1 file_bytes=26200"
    "load_bytes=2464 memory_bytes=2464 address_space="
    ...
    "SLOPOS-PROCESS: pid=1 state=exited status=0 syscalls=16 retained=true kernel_return=true"
