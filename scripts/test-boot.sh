...
required_markers=(
    ...
    "SLOPOS-EXT4: in-place write valid inode=25 physical_block=98 bytes=4096 writes=2 flushes=2 cache_invalidations=2 restored=true path=/usr/share/slopos/write-probe.bin"
    "SLOPOS-FS: block cache entries=8 hits=60 misses=47 batched_pairs=1 invalidations=2"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=52 max_in_flight=2 interrupts=51 queue_interrupts=51"
