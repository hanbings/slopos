...
required_markers=(
    ...
    "SLOPOS-EXT4: multiblock file valid inode=21 inode_group=1 bytes=6144 logical_blocks=2 path=/usr/share/slopos/multiblock.bin"
    ...
    "SLOPOS-FS: block cache entries=8 hits=26 misses=23 batched_pairs=1"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=24 max_in_flight=2 interrupts=23 queue_interrupts=23"
