...
required_markers=(
    ...
    "SLOPOS-VFS: executable loaded path=/sbin/slop-shell inode=24 bytes=26592 blocks=7 matches_boot=not-required role=desktop-service"
    ...
    "SLOPOS-PROCESS: pid=2 parent=1 source=vfs path=/sbin/slop-shell argv1=--session format=elf64 entry=0x40000000 segments=1 file_bytes=26592 load_bytes=2560 memory_bytes=2560"
    "SLOPOS-PROCESS: pid=2 initial_stack abi=linux-x86_64 rsp=0x40002ea0 aligned=16 stack_pages=2 argc=2 argv0=/sbin/slop-shell argv1=--session envc=4 auxv_pairs=9 bytes=352"
