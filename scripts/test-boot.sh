...
required_markers=(
    ...
    "SLOPOS-FS: block cache entries=8 hits=39 misses=39 batched_pairs=1"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=40 max_in_flight=2 interrupts=39 queue_interrupts=39"
