...
required_markers=(
    ...
    "SLOPOS-PROCESS: pid=2 parent=1 source=vfs path=/sbin/slop-shell argv1=--session format=elf64 entry=0x40000000 segments=1 file_bytes=40960 load_bytes=15072 memory_bytes=15072"
    ...
    "SLOPOS-IPC: AF_UNIX SOCK_STREAM listener bound path=/run/slopos/wayland-0 backlog=2 bytes_per_direction=512"
    ...
    "SLOPOS-IPC: AF_UNIX connected pid=2 path=/run/slopos/wayland-0 client=1:1 server=2:1 transport=bounded-stream"
    ...
    "SLOPOS-IPC: process read complete pid=2 fd=3 family=AF_UNIX type=SOCK_STREAM requested=256 bytes=156 user_pages=1 async=true"
    "SLOPOS-SYSCALL: pid=2 abi=linux-x86_64 entry=syscall return=suspended nr=47 recvmsg fd=3 requested=256 control_capacity=24 user_pages=1 origin=cpl3"
    ...
    "SLOPOS-IPC: process read complete pid=2 fd=3 family=AF_UNIX type=SOCK_STREAM requested=32 bytes=32 user_pages=1 async=true"
    "SLOPOS-IPC: process read complete pid=2 fd=4 object=memfd shared=0:1 offset=3072 requested=235 bytes=235 object_bytes=3307 user_pages=1 async=false"
    ...
    "SLOPOS-IPC: process close complete pid=2 fd=4 object=memfd shared=0:1 async=false"
    "SLOPOS-SYSCALL: pid=2 abi=linux-x86_64 entry=syscall return=sysretq nr=319 memfd_create name=slopos-wayland-shm flags=0 fd=4 object=1:1 origin=cpl3"
    "SLOPOS-SYSCALL: pid=2 abi=linux-x86_64 entry=syscall return=sysretq nr=77 ftruncate fd=4 bytes=3072 object=1:1 origin=cpl3 result=0"
    "SLOPOS-SYSCALL: pid=2 abi=linux-x86_64 entry=syscall return=sysretq nr=9 mmap address=0x40007000 bytes=4096 prot=read/write flags=MAP_SHARED fd=4 offset=0 object=1:1 object_bytes=3072 physical="
    "SLOPOS-SYSCALL: pid=2 abi=linux-x86_64 entry=syscall return=suspended nr=46 sendmsg fd=3 requested=148 control=SCM_RIGHTS rights_fd=4 user_pages=1 origin=cpl3"
    "SLOPOS-IPC: process write complete pid=2 fd=3 family=AF_UNIX type=SOCK_STREAM operation=sendmsg/SCM_RIGHTS requested=148 bytes=148 user_pages=1 async=true"
    ...
    "SLOPOS-IPC: process close complete pid=2 fd=4 object=memfd shared=1:1 async=false"
    ...
    "SLOPOS-VFS: process event stream open complete pid=2 fd=4 object=desktop-events cursor_generation=1 access=readonly path=/run/slopos/desktop-events"
