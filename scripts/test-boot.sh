...
required_markers=(
    ...
    "SLOPOS-FS: block cache entries=8 hits=64 misses=54 batched_pairs=1 invalidations=5"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=193 max_in_flight=2 interrupts=192 queue_interrupts=192"
