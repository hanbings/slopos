...
required_markers=(
    ...
    "SLOPOS-SHELL: config loaded niri_workspaces=3 named=2 binds=37 rules=1 active_columns=2 gaps=16 default_width=50% center=never waybar_position=top height=40 spacing=10 modules=1/1/4 module_configs=6 css_rules=12"
