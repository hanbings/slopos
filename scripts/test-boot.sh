...
required_markers=(
    ...
    "SLOPOS-FS: block cache entries=8 hits=62 misses=49 batched_pairs=1 invalidations=2"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=83 max_in_flight=2 interrupts=82 queue_interrupts=82"
