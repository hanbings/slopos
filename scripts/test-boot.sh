...
required_markers=(
    ...
    "SLOPOS-VFS: executable loaded path=/sbin/slop-shell inode=24 bytes=27128 blocks=7 matches_boot=not-required role=desktop-service"
    ...
    "SLOPOS-PROCESS: pid=2 parent=1 source=vfs path=/sbin/slop-shell argv1=--session format=elf64 entry=0x40000000 segments=1 file_bytes=27128 load_bytes=3264 memory_bytes=3264"
    ...
    "SLOPOS-VFS: process read complete pid=2 fd=3 inode=17 offset=0 requested=172 bytes=172 user_pages=1 cross_page=false async=true"
    ...
    "SLOPOS-PROCESS: pid=2 state=exited status=0 syscalls=16 preemptions="
