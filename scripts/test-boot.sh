...
required_markers=(
    ...
    "SLOPOS-FS: block cache entries=8 hits=65 misses=59 batched_pairs=1 invalidations=11"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=318 max_in_flight=2 interrupts=317 queue_interrupts=317"
