...
required_markers=(
    ...
    "SLOPOS-FS: block cache entries=8 hits=50 misses=41 batched_pairs=1"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=42 max_in_flight=2 interrupts=41 queue_interrupts=41"
