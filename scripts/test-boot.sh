...
required_markers=(
    ...
    "SLOPOS-FS: block cache entries=8 hits=62 misses=51 batched_pairs=1 invalidations=4"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=120 max_in_flight=2 interrupts=119 queue_interrupts=119"
