...
required_markers=(
    ...
    "SLOPOS-EXT4: root directory valid group_inode_table=49 inode=2 extent_block=18 entries=4 etc_inode=13 lost_found_inode=11 metadata_checksums=group/inode/directory"
    ...
    "SLOPOS-VIRTIO: async block sequence complete requests=18 interrupts=18 queue_interrupts=18"
