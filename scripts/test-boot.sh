...
required_markers=(
    ...
    "SLOPOS-VIRTIO: modern block queue ready size=8 capacity_sectors=262144"
    "SLOPOS-EXT4: superblock valid label=SLOPOS_ROOT"
    "SLOPOS-EXT4: root directory valid group_inode_table=49 inode=2 extent_block=18 entries=5 etc_inode=13 lost_found_inode=11 metadata_checksums=group/inode/directory"
    ...
    "SLOPOS-EXT4: multiblock file valid inode=20 bytes=6144 logical_blocks=2 path=/usr/share/slopos/multiblock.bin"
    "SLOPOS-VIRTIO: async block sequence complete requests=29 interrupts=29 queue_interrupts=29"
