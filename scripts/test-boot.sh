...
required_markers=(
    ...
    "SLOPOS-PROCESS: pid=2 parent=1 source=vfs path=/sbin/slop-shell argv1=--session format=elf64 entry=0x40000000 segments=1 file_bytes=40960 load_bytes=12984 memory_bytes=12984"
    ...
    "SLOPOS-WAYLAND-SERVER: event sent pid=2 transport=AF_UNIX/SOCK_STREAM kind=3 sequence=3 wire_bytes=76 read_bytes=76 scm_rights=false"
    ...
    "SLOPOS-DESKTOP-SERVICE: policy submitted pid=2 generation=2 protocol=1 capabilities=waybar-provider/swww-policy/wayland-surface cpu=0 memory=36 wallpaper=aurora"
    "SLOPOS-VFS: process open complete pid=2 fd=4 inode=20 bytes=904 access=readonly async=true path=/etc/slopos/waybar.jsonc"
