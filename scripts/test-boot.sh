...
required_markers=(
    ...
    "SLOPOS-FS: block cache entries=8 hits=20 misses=14 batched_pairs=1"
    "SLOPOS-VIRTIO: bounded block sequence complete requests=15 max_in_flight=2 interrupts=14 queue_interrupts=14"
