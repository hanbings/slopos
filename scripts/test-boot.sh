...
required_markers=(
    ...
    "SLOPOS-VFS: executable loaded path=/sbin/slop-shell inode=24 bytes=36608 blocks=9 matches_boot=not-required role=desktop-service"
    ...
    "SLOPOS-PROCESS: pid=2 parent=1 source=vfs path=/sbin/slop-shell argv1=--session format=elf64 entry=0x40000000 segments=1 file_bytes=36608 load_bytes=10136 memory_bytes=10136"
    ...
    "SLOPOS-WAYLAND-SERVER: request received pid=2 transport=AF_UNIX/SOCK_STREAM path=/run/slopos/wayland-0 wire_bytes=12"
    ...
    "SLOPOS-WAYLAND-SERVER: request received pid=2 transport=AF_UNIX/SOCK_STREAM path=/run/slopos/wayland-0 wire_bytes=216"
    "SLOPOS-WAYLAND-SERVER: event sent pid=2 transport=AF_UNIX/SOCK_STREAM kind=2 sequence=2 wire_bytes=56 read_bytes=56"
    "SLOPOS-SYSCALL: pid=2 abi=slopos-wayland-backing-bootstrap-v1 entry=syscall return=sysretq nr=1397489669 pixel_bytes=3072 future_transport=SCM_RIGHTS/mmap origin=cpl3 result=0"
    ...
    "SLOPOS-WAYLAND-SERVER: request received pid=2 transport=AF_UNIX/SOCK_STREAM path=/run/slopos/wayland-0 wire_bytes=148"
    ...
    "SLOPOS-WAYLAND-SERVER: request received pid=2 transport=AF_UNIX/SOCK_STREAM path=/run/slopos/wayland-0 wire_bytes=64"
