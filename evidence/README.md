...
| `interaction-serial.log` | `make test-interaction` | PS/2 键盘触发 VFS 配置 reload/rollback、执行 `STATUS`/swww，鼠标横拖 viewport，Super bind 缩放/重排/关闭窗口并切换 workspace |
