...
| `wallpaper-vfs-loaded.png` | `make test-interaction` | `swww img /usr/share/slopos/vfs-wallpaper.ppm` 令 block task 从 inode 30 异步读齐两个 block，经双 bank 发布 P6 binary raster 后完成 center transition；Terminal 显示 `SWWW VFS IMAGE APPLIED` |
