...
| `wallpaper-wipe-angle.png` | `make test-interaction` | `wipe --transition-angle 30` 完成后恢复 Sunset；serial 锁定 angle 30 与 5 个有界采样帧 |
