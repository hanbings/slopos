...
桌面服务另使用 SlopOS 私有的 40-byte versioned commit 和 32-byte blocking event syscall；它们不是 Linux ABI。尚无任意路径/多 segment exec、动态链接、广泛 POSIX syscall、VM proxy 或 guest agent。
