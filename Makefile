...
.PHONY: all build rootfs image run test-acpi test-ebpf test-elf test-pci test-virtio test-ext4 test-vfs test-boot test-interaction test-page-fault test-journal-replay clean
