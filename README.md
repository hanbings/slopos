...
- swww 式 daemon 状态、`img/clear/query/kill` 命令、环境默认值、crop/fit/no/stretch、fill/crop-gravity 与显式 Nearest/Bilinear/卷积名 filter 图像落屏，以及带 angle/position/invert-y、毫秒小数 duration×fps 有界采样、可配置 cubic Bezier easing 和 wave 宽高的 CPU fade/wipe/wave/grow transition；
