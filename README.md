...
- swww 式 daemon 状态、`img/clear/query/kill` 命令、环境默认值、crop/fit/no/stretch 与 fill/crop-gravity 图像落屏，以及带 angle/position/invert-y、毫秒小数 duration×fps 有界采样的 CPU wipe/grow transition；
