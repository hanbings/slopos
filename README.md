...
- Waybar JSONC 驱动的 left/center/right 顶部 module 栏、module format/interval/length/`on-click` option，以及可点击的 `niri/workspaces` 数字；
